...
class AddClientFemaleScreen extends StatefulWidget {
  const AddClientFemaleScreen({super.key});

  @override
  State<AddClientFemaleScreen> createState() => _AddClientFemaleScreenState();
}

class _AddClientFemaleScreenState extends ClientFormState<AddClientFemaleScreen> {
  @override
  void initState() {
    super.initState();
    initDefaultMeasurements('female');
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Ajouter • Femme  🧵')),
      body: LayoutBuilder(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: const Text('Enregistrer le client', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                        ),
                      ),
                    ],
                  ),
