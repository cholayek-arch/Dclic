...
class _AddClientFemaleScreenState extends State<AddClientFemaleScreen> {
  ...
  Future<void> _save() async {
    ...
    final client = Client(id: id, name: name, gender: 'female', measurements: measurements, photos: _photoPaths);
