...
class _AddClientScreenState extends State<AddClientScreen> {
  ...
  Future<void> _save() async {
    ...
    final client = Client(id: id, name: name, measurements: measurements, photos: _photoPaths);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Ajouter • Client  🧵')),
      body: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Column(
                        children: [
                          CircleAvatar(radius: 28, backgroundColor: _gender == 'male' ? Colors.teal : Colors.grey.shade200, child: Icon(Icons.male, color: _gender == 'male' ? Colors.white : Colors.black54, size: 28)),
                          const SizedBox(height: 6),
                          Text('Homme', style: Theme.of(context).textTheme.bodyMedium)
                        ],
                      ),
                    ),
                    ...
                    GestureDetector(
                      ...
                      child: Column(
                        children: [
                          CircleAvatar(radius: 28, backgroundColor: _gender == 'female' ? Colors.pinkAccent : Colors.grey.shade200, child: Icon(Icons.female, color: _gender == 'female' ? Colors.white : Colors.black54, size: 28)),
                          const SizedBox(height: 6),
                          Text('Femme', style: Theme.of(context).textTheme.bodyMedium)
                        ],
                      ),
                    ),
                  ],
